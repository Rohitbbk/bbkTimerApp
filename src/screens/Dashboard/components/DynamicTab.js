    ...
    return (
      ...
      <TouchableOpacity
        style={{
          ...
          onPress={this.props.addNewOvenDeck}
...
const styles = StyleSheet.create({
  ...
  setText:{color:'black',width:90,textAlign:'center',fontSize:18},
  ...
  timerTextView:{height:90,width:90,backgroundColor:'black',borderRadius:45,justifyContent:'center',alignItems:'center'},
